export default {
  nav: {
    ...
    walletSynced: "Кошелёк синхронизирован",
    walletSyncing: "Синхронизация кошелька ({pct}%)",
    daemonSynced: "Демон синхронизирован ({height})",
    daemonSyncing: "Синхронизация демона ({pct}%)",
  ...
  fieldLabels: {
    ...
    theme: "ТЕМА",
    privateViewKey: "СЕКРЕТНЫЙ КЛЮЧ ПРОСМОТРА",
    privateSpendKey: "СЕКРЕТНЫЙ КЛЮЧ ТРАТЫ",
  ...
  menuItems: {
    ...
    showPrivateKeys: "Показать сид и ключи",
    showQRCode: "Показать QR Код",
  ...
  notification: {
    ...
    errors: {
      ...
      invalidPrivateSpendKey: "Неверный секретный ключ траты",
    ...
    warnings: {
      ...
      usingRemoteNode: "Не найден файл judecoind, используется удаленная нода"
    }
  },
  placeholders: {
    ...
    mnemonicSeed: "Seed-фраза, состоящая из 25 слов",
  ...
  strings: {
    ...
    judecoinBalance: "Баланс",
    judecoinUnlockedBalance: "Разблокированый баланс",
    judecoinUnlockedShort: "Разблокировано",
  ...
  titles: {
    ...
    wallet: {
      ...
      restoreFromKeys: "Восстановить кошелёк из ключей",
      restoreViewOnly: "Восстановить кошелек только-для-чтения"
    },
    welcome: "Добро пожаловать",
    welcomeToJude: "Добро пожаловать в JUDE",
