export default {
  nav: {
    ...
    walletSynced: "Wallet ist synchronisiert",
    walletSyncing: "Wallet wird synchronisiert ({pct}%)",
    daemonSynced: "Daemon ist synchronisiert ({height})",
    daemonSyncing: "Daemon wird synchronisiert ({pct}%)",
  ...
  dialog: {
    ...
    showPrivateKeys: {
      title: "Seed und Schlüssel anzeigen",
  ...
  fieldLabels: {
    ...
    theme: "DESIGN",
    privateViewKey: "PRIVATER ANZEIGE-SCHLÜSSEL",
    privateSpendKey: "PRIVATER AUSGABE-SCHLÜSSEL",
  ...
  menuItems: {
    ...
    showPrivateKeys: "Zeige Seed und Schlüssel",
  ...
  notification: {
    ...
    errors: {
      ...
      invalidPrivateSpendKey: "Ungültiger privater Ausgabeschlüssel",
    ...
    warnings: {
      ...
      usingRemoteNode: "judecoind nicht gefunden, benutze eine Remote Node"
    }
  },
  placeholders: {
    ...
    mnemonicSeed: "25 mnemonic Seed Wörter",
  ...
  strings: {
    ...
    judecoinBalance: "Guthaben",
    judecoinUnlockedBalance: "frei verfügbares Guthaben",
    judecoinUnlockedShort: "frei verfügbar",
  ...
  titles: {
    ...
    privateKeys: "Seed und Schlüssel",
    rescanWallet: "Wallet erneut scannen",
    serviceNode: {
    ...
    wallet: {
      ...
      restoreFromKeys: "Wallet aus Schlüsseln wiederherstellen",
      restoreViewOnly: "Wiederherstellung Anzeige Wallet"
    },
    welcome: "Willkommen",
    welcomeToJude: "Willkommen bei JUDE",
