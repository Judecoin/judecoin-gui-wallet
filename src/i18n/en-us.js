export default {
  nav: {
    ...
    walletSynced: "Wallet is synchronized",
    walletSyncing: "Wallet is syncing ({pct}%)",
    daemonSynced: "Daemon is synchronized ({height})",
    daemonSyncing: "Daemon is syncing ({pct}%)",
  ...
  menuItems: {
    ...
    showPrivateKeys: "Show Seed and Keys",
    showQRCode: "Show QR Code",
  ...
  notification: {
    ...
    errors: {
      ...
      invalidPrivateSpendKey: "Invalid private spendkey",
    ...
    warnings: {
      ...
      usingRemoteNode: "judecoind not found, using remote node"
    }
  },
  placeholders: {
    ...
    onsName: "The name to purchase via Jude Name Service",
    ...
    mnemonicSeed: "25 word mnemonic seed",
    publicWalletAddress: "The wallet's main public address (begins with J)",
    ...
    sessionId: "The Session ID to link to Jude Name Service",
  ...
  strings: {
    ...
    judecoinAccumulatedRewards: "Accumulated rewards",
    judecoinUnlockedBalance: "Unlocked balance",
    judecoinUnlockedShort: "Unlocked",
    me: "Me",
    ...
    serviceNodeContributionDescription:
      "Staking contributes to the safety of the Judecoin network. For your contribution, you earn JUDE. Once staked, you will have to wait 180 days to have your JUDE unlocked. To learn more about staking, please visit the",
  ...
  titles: {
    ...
    wallet: {
      ...
      restoreFromKeys: "Restore wallet from keys",
      restoreViewOnly: "Restore view-only wallet"
    },
    welcome: "Welcome",
    welcomeToJude: "Welcome to JUDE",
