export default {
  ...
  notification: {
    ...
    warnings: {
      ...
      usingRemoteNode: "judecoind não encontrado, utilizando nódulo remoto"
    }
  },
  placeholders: {
    ...
    mnemonicSeed: "25 palavras semente mnemónicas",
    ...
    walletPassword: "Palavra-passe da carteira"
  },
  strings: {
    ...
    judecoinUnlockedBalance: "Saldo desbloqueado",
    judecoinUnlockedShort: "Desbloqueado",
  ...
  titles: {
    ...
    welcome: "Bem-vindo",
    welcomeToJude: "Bem-vindo ao JUDE",
