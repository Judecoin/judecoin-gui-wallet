              ...
              <div class="row justify-between" style="max-width: 768px">
                <div class="infoBox">
                  <div class="infoBoxContent">
                    <div class="text">
                      <span>{{ $t("strings.judecoinBalance") }}</span>
                    </div>
                    <div class="value">
                      <span><FormatJudecoin :amount="address.balance"/></span>
                    </div>
                  </div>
                </div>
                ...
                <div class="infoBox">
                  <div class="infoBoxContent">
                    <div class="text">
                      <span>{{ $t("strings.judecoinUnlockedBalance") }}</span>
                    </div>
                    <div class="value">
                      <span
                        ><FormatJudecoin :amount="address.unlocked_balance"
                      /></span>
                    </div>
                  </div>
                </div>
