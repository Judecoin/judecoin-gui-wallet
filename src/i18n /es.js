export default {
  nav: {
    ...
    walletSynced: "La cartera está sincronizada",
    walletSyncing: "Sincronizando cartera ({pct}%)",
    daemonSynced: "El daemon está sincronizado ({height})",
    daemonSyncing: "Sincronizando daemon ({pct}%)",
  ...
  dialog: {
    ...
    showPrivateKeys: {
      title: "Mostrar semilla y claves",
  ...
  fieldLabels: {
    ...
    theme: "TEMA",
    privateViewKey: "CLAVE DE VISTA PRIVADA",
    privateSpendKey: "CLAVE DE GASTO PRIVADA",
  ...
  menuItems: {
    ...
    exit: "Cerrar la interfaz del monedero Jude",
    ...
    showPrivateKeys: "Mostrar Semilla y Claves",
    showQRCode: "Mostrar código QR",
  ...
  notification: {
    ...
    errors: {
      ...
      invalidPrivateSpendKey: "Clave de gasto privada no válida",
    ...
    warnings: {
      ...
      usingRemoteNode: "judecoind no encontrado, utilizando nodo remoto"
    }
  },
  placeholders: {
    ...
    mnemonicSeed: "Semilla mnemónica de 25 palabras",
  ...
  strings: {
    ...
    judecoinUnlockedBalance: "Saldo libre",
    judecoinUnlockedShort: "Libre",
    ...
    serviceNodeRegistrationDescription:
      'Introduzca la orden {registerCommand} generada por el servicio (judecoind) que se está intentado registrar como Nodo de Servicio usando la instrucción "{prepareCommand}"',
    spendKey: "Clave de gasto",
  ...
  titles: {
    ...
    wallet: {
      ...
      restoreFromKeys: "Restaurar billetera desde claves",
      restoreViewOnly: "Restaurar monedero de solo visualización"
    },
    welcome: "Bienvenido/a",
    welcomeToJude: "Bienvenido a JUDE",
