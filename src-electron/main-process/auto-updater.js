...
async function showUpdateDialog(mainWindow) {
  ...
  const options = {
    ...
    title: "Jude Desktop Wallet update available",
    message: "There is a new version of Jude Desktop Wallet available.",
...
async function showCannotUpdateDialog(mainWindow) {
  const options = {
    ...
    title: "Cannot update",
    message:
      "Jude Desktop Wallet failed to update but there is a new version available. Please install the new version manually."
  };
